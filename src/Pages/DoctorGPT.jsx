...
const DoctorGPT = () => {
  ...
  const appendMessage = (sender, message) => {
    ...
    messageElement.className = `flex ${
      sender == "User" ? "items-start" : "items-end"
    } flex flex-col`;
    messageElement.innerHTML = `
			...
			<div class="${
        sender == "User"
          ? "bg-main text-OpenColor-gray-0 break-all"
          : sender == "Error"
          ? "bg-OpenColor-red-1"
          : "bg-OpenColor-gray-1"
      } p-2 rounded-lg whitespace-pre-wrap">${message}</div>`;
    ...
    <>
      <div className="container mx-auto">
        ...
        <motion.div
          ...
          className={`${!animationDone && "duration-0"} max-w-4xl mx-auto p-4`}
        >
          <div
            id="chat-container"
          ...
          >
            <div className="text-center text-sm">
              ...
              <div className="pt-4 text-center text-sm">
                <div dir="ltr">
                  If the app is giving the error message{" "}
                  <span className="text-OpenColor-red-7">401</span> please set
                  your OpenAI API Key.
                </div>
                <div>
                  إذا كان التطبيق يعطي رسالة الخطأ{" "}
                  <span className="text-OpenColor-red-7">401</span> فالرجاء
                  تعيين OpenAI API Key الخاص بك.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto p-4">
          <motion.div
            ...
            id="chat-container"
            className={`${
              !animationDone && "duration-0"
            } bg-white p-4 rounded-lg shadow-lg overflow-hidden`}
          >
            <div className="text-center font-bold text-2xl p-4 pt-0">
              DoctorGPT
            </div>
            <hr />
            ...
            <div ref={lastMessageRef} className="pt-4 text-center text-sm">
              <div dir="ltr">
                DoctorGPT is still under development if you face any errors
                please{" "}
                <a
                  className="text-main"
                  target="_blank"
                  href="https://github.com/OmarAfet/SmartAI/issues/new"
                >
                  contact us
                </a>
              </div>
