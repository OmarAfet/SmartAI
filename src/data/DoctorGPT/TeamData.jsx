export default [
	{
		name: "عمر العنزي",
		description: "قائد الفريق والمطور الرئيسي لـ SmartAI. وهو مهندس برمجيات حر لديه أكثر من 5 سنوات من الخبرة في تطوير وتصميم التطبيقات الذكية. مبدع وشغوف بالتكنولوجيا، ويؤمن بإمكانية استخدام الذكاء الاصطناعي لتحسين حياة الناس.",
	...
	{
		name: "شهد المطرفي",
		description: "صاحبة فكرة تطبيق DoctorGPT. لديها اهتمام كبير بتطوير تطبيقات الذكاء الاصطناعي في مجال الرعاية الصحية. وهي ملتزمة بتطوير تطبيق DoctorGPT ليكون أداة قيمة للمرضى.",
		badge: (
	...
	{
		name: "مريم الفقيهي",
		description: "مسؤولة عن إنشاء الفيديوهات التي تشرح تطبيق DoctorGPT. وهي مصممه فيديوهات موهوبة ولديها خبرة في إنتاج فيديوهات إبداعية عالية الجودة.",
		badge: (
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
	...
	{
		name: "سجا الامير",
		description: "مسؤولة عن البرزنتيشن لـ DoctorGPT. لديها خبرة في تقديم البرزنتيشن الرائعة. ولديها شغف بمشاركة أفكارها مع العالم.، وهي ملتزمة بمشاركة قصة SmartAI مع أكبر عدد ممكن من الناس.",
		badge: (
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
	...
	{
		name: "أمجاد المطيري",
		description: "مسؤولة عن تقديم العروض التقديمية لتطبيق DoctorGPT. وهي شخص متمكن من التواصل، ولديها قدرة رائعة على إقناع الآخرين, ملتزمة بجعل SmartAI اسماً معروفاً في مجال الذكاء الاصطناعي.",
		badge: (
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
