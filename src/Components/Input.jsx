const Input = ({ name, classes, value, onBlur, onChange, type, placeholder, onKeyDown }) => {
	return (
		<>
			<textarea autoComplete="off" value={value} title="" type={type} id={placeholder} onKeyDown={onKeyDown} onBlur={onBlur} onChange={onChange} className="flex-1 border-2 focus:border-main rounded-lg px-2 py-1 peer duration-0 h-[40px] min-h-[40px] max-h-[200px]" />
