...
const Story = () => {
	const [animationStates, setAnimationStates] = useState(Array(StoryData.length).fill(false));
			...
			<div className="flex flex-col gap-32 my-32">
				{StoryData.map((story, index) => (
					<motion.div
						...
						className={`${!animationStates[index] ? "duration-0" : ""} flex flex-col justify-center text-center items-center xl:grid xl:grid-cols-3`}
					>
						<div className="flex justify-start items-center">{story.svg}</div>
						<div className="col-span-2">
							<div className="lg:text-8xl text-6xl font-bold pb-16">{story.header}</div>
